...
/* funkcja wykonywana w w±tku - zwiêksza licznik */
...
int main(int argc, char* argv[]) {
	...
	/* utworzenie kilku w±tków w±tku z ró¿nymi priorytetami */
	for (i=0; i < N; i++) {
	...
	/* ustawienie flagi zakoñczenia pracy, któr± testuj± funkcje w±tków 
	   oraz odczyt ich bie¿±cych liczników */
	for (i=0; i < N; i++) {
		arg[i].przerwij = 1;
	...
	/* teraz oczekiwanie na ich zakoñczenie */
	for (i=0; i < N; i++) {
